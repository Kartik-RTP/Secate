<html lang="en">
  ...
  <body>
      <nav style="background:#193655 " class="navbar navbar-default navbar-fixed-top">
          <div class="container">
            <a class="navbar-brand" href="admin_index.php">Secate Web Portal</a>
          </div>
      </nav>
      <div style="background:#1d3f63 !important" class="jumbotron" id="admin_header">
          ...
          <nav role="navigation" class="navbar navbar-default">
              ...
              <div id="navbarCollapse" class="collapse navbar-collapse">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                      ...
                      <li><a href="admin_settings.php">Change Password</a></li>
