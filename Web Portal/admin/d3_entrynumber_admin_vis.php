...
// check whether to put date also in left side of d3
...
if (isset($_POST['signup'])){
     ...
     $fp = fopen('data_'.$_SESSION['admin'].'.csv','w');
    ...
    $start_date = date('d-m-Y',$x);
      ...
      $query = "SELECT entry_exit_table.entry_no,entry_exit_table.date_out,entry_exit_table.time_out
                ...
                AND place = 'null' AND entry_exit_table.entry_no='{$e_no}'
                AND entry_exit_table.date_out  = '{$start_date}'";  
  ...
  <body>
    ...
    <script type="text/javascript">
     var x = "<?php echo main_func(); ?>" ;
       ...
       var margin = { top: 70, right: 10, bottom: 150, left: 90 },
        ...
        <?php
         ...
         ?>
          ...
          datasets = ["data_"+"<?php echo $_SESSION['admin'];?>"+".csv"];
