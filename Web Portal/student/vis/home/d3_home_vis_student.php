...
if (isset($_POST['signup'])){
   ...
   $email = $_SESSION['student'];
    ...
    $arr = array_fill(0, 2, array_fill(0, 32, 0));
      ...
      $query = "SELECT entry_exit_table.date_out,entry_exit_table.time_out
                FROM entry_exit_table,usr_details  
                WHERE entry_exit_table.entry_no = usr_details.entry_no 
                AND entry_exit_table.place  != 'null' AND usr_details.email = '{$email}' 
                AND entry_exit_table.date_out LIKE '%-$month_val-%' ";  
